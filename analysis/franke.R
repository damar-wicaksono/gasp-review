#
# title     :
# purpose   : Analysis of Franke's Function using Gaussian Process
# author    : WD41
# date      : 18.04.2017
#
...
hist(1/y_tests)
min(y_tests)
hist(log(y_tests+(1-min(y_tests))))
hist(sqrt(y_tests+(1-min(y_tests))))
hist(y_tests+(1-min(y_tests)))
...
saveRDS(err_franke, "err_franke.rds")
